...
public final class HuaweiLocationRequest implements LocationRequest {

    private final com.huawei.hms.location.LocationRequest mDelegate =
    ...
    public @NonNull LocationRequest setPriority(int priority) {
        switch (priority) {
            case PRIORITY_HIGH_ACCURACY:
                ...
                priority = com.huawei.hms.location.LocationRequest
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        HuaweiLocationRequest that = (HuaweiLocationRequest) obj;
    ...
    public static @NonNull com.huawei.hms.location.LocationRequest unwrap(
            @NonNull LocationRequest wrapped) {
        return ((HuaweiLocationRequest) wrapped).mDelegate;
    }
